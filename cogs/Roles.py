                ...
                while True:
                    ...
                    if answer.content.lower().startswith("oui"):
                        if ctx.author in role.members:
                            ...
                            await ctx.author.add_roles(role)
                            await ctx.send(
                                "Alors ok, tu as maintenant le rôle %s ! Vous êtes %i. Je crois. Mais je suis pas fort en math." % (
                    ...
                    # Non c'est pas ce que je voulais dire
                        ...
                        while True:
                            ...
                            if answer.content.lower().startswith("oui"):
                                ...
                                await ctx.send(
                                    "Ok, tu l'auras voulu. Tu as maintenant le rôle %s. Vous êtes %i. Je crois. Mais je suis pas fort en math." % (
                                    newRole.name, len(newRole.members)))
                                return
